...
sudo cd /scripts
sudo wget --no-check-certificate  https://raw.githubusercontent.com/topgg/smtp-watcher/master/smtpwatcher.sh -O smtpwatcher.sh && sudo chmod 755 smtpwatcher.sh
